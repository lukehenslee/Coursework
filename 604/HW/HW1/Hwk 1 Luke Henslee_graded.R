...
#====================================================================
# This is higher than it should be because you used the variance of 
# fecundity within each lage, rather than the variance of the mean.
# To compute egg production you multiply numbers of fish by mean fecundity.
# To compute its uncertainty, you would therefore use the variance (squared
# standard error) of the mean fecundity. See solutions
#       3 of 4 points
#====================================================================
...
#====================================================================
# Correct calculatioin but input (sd.egg) is too large
#====================================================================
...
#====================================================================
# OK, but skewness is not defined relative to a normal distribution
